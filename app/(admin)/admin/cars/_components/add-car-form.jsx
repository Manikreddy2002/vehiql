...
const AddCarForm = () => {
  ...
  const OnMultiImageOnDrop = (acceptedFiles) => {
  ...
  const { getRootProps: getMultiImageRootProps, getInputProps: getMultiImageInputProps, isDragActive, isDragReject } =
    useDropzone({
      onDrop: OnMultiImageOnDrop,
      accept: {
        "image/*": [".jpeg", ".jpg", ".png", ".webp"],
      },
      multiple: true,
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  < div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={`form-field ${errors.make ? "border-red-500" : ""}`}
                    />
                    {errors.make && (
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger
                        className={`form-field ${errors.fuelType ? "border-red-500" : ""}`}
                      >
                ...
                <div>
                  ...
                  <div
                    {...getMultiImageRootProps()} className={` border-2 border-dashed rounded-lg p-6 text-center cursor-pointer hover:bg-gray-50 transition  mt-2 ${imageError ? "border-red-500" : "border-gray-500"}`}

                  >
                    <input {...getMultiImageInputProps()} />
                    <div className='flex flex-col items-center justify-center'>
                      <Upload className='h-12 w-12 text-gray-400 mb-' />
                      <p className=' text-sm text-gray-600 '>


                        Drag & drop or click to upload multiple iamges
                ...
                </div>
                {
                  uploadedImages.length > 0 && (
                    <div className='mt-4'>
                      <h3 className='text-smi font-medium mb-2'>
                  ...
                  <div {...getAiRootProps()} className='cursor-pointer hover:bg-gray-50 transition'>
                    ...
                    <div className='flex flex-col items-center justify-center'>
                      ...
                      <p className='text-gray-600 text-sm'>
                        ...
                        Drag & drop a car image or  click to upload a image .
